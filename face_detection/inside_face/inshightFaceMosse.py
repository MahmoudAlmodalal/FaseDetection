...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="InsightFace + Norfair tracking with a tighter threshold")
    ...
    parser.add_argument("--distance", type=float, default=20.0, help="Tracker distance threshold")
